...
class Plane : GameObject {
    ...
    var numberOfBullets: Int {
        ...
        set(value) {
            ...
            Debug("\(self) has \(_numberOfBullets) bullets left")
        }
    }
    ...
    override func update(atTime time: TimeInterval, level: GameLevel) {
        ...
        //control minimum/maximum height
        ...
        // control minimum/maximum left/right
    ...
    override init() {
        ...
        // Contact box
        // Instead of use the plane itself we add a collision node to the player object
